...
# Description
This Rmd script import all male data for the final project and combine them into a single dataframe. For female data, goto another rmd file named "FemaleDataImport".
...
```{r}
setwd("~/Desktop/TRGN510/FinalProject/Data/")
check.MData <- read.csv("MaleData.csv", header = T, row.names = 1)
```

# It works! Great! Then we can use the same way to import all female data. To make it more clear, I do that work in another rmd file named FemaleDataImport.
