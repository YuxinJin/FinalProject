...
# Description
This Rmd script import all female data for the final project and combine them into a single dataframe. For male data, goto another rmd file named "MaleDataImport".
...
```{r}
setwd("~/Desktop/TRGN510/FinalProject/Data/")
check.FData <- read.csv("FemaleData.csv", header = T, row.names = 1)
```

It works! Great! Then we can use the same way to import all male data. To make it more clear, I do that work in another rmd file named MaleDataImport.
